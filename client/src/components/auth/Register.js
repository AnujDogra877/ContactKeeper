        ...
        <div className="form-container">
            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    <input type="text" name='password2' value={password2} placeholder='Enter Confirm Password' onChange={onChange}/>
                </div>
                <input type="submit" value="Register" onSubmit={onSubmit} className='btn btn-primary btn-block'/>
            </form>
        </div>
    )
}
